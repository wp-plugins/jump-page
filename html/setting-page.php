...
+----------------------------------------------------------------+
+	Jump-Page [v2.0]
+	by Stefan Natter (http://www.gb-world.net and http://www.gangxtaboii.com)
...
<?php 
	...
	define('IS_GB_JP_V25', version_compare(gxtb_jump_page_version, '2.5', '>=') );
        ...
        <table class="form-table" style="width: 70%;" border="0">
		        <tbody>
                    ...
                    <tr>
						...
						<?php if (!IS_GB_JP_V25)
							_e('Available at', 'gb-jump-page') ?> [v2.5]</strong></td>
                        <td width="80%" valign="bottom">
                        	<input <?php if (!IS_GB_JP_V25) { ?>disabled="disabled" <?php } ?> type="checkbox" class="checkbox" name="gxtb_jump_page_exli" <?php if (isset($gxtb_jump_page_exli) && $gxtb_jump_page_exli == "on") echo("checked"); ?> />
                         </td>
                    </tr>
                    <tr>
...
<?php		
		//This works only in GB-JP-Version 2.5 or higher
		if ( IS_GB_JP_V25 == TRUE) {
?>
<div class="stuffbox">
