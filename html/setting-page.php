...
<form method="post">
<div id="poststuff" class="metabox-holder" style="width: 70%;">
        ...
        <table class="form-table" style="width: 70%;" border="0">
		        <tbody>
                    ...
                    <tr>
                        <td><small><?php _e('Example', 'gb-jump-page') ?>: <?php _e('http://www.yourdomain.com/jump-page/', 'gb-jump-page') ?> <?php _e('or', 'gb-jump-page') ?> <?php _e('http://www.yourblog.com/?page_id=67', 'gb-jump-page') ?></small></td>
                   </tr>
                    ...
                    <tr>
                        ...
                        <td width="80%" valign="bottom">
                        	<input type="checkbox" class="checkbox" name="$gxtb_jump_page_ads_on" <?php if (isset($gxtb_jump_page_ads_on) && $gxtb_jump_page_ads_on == "on") echo("checked"); ?> />
                         </td>
                    </tr>
                    <tr>
...
<div class="stuffbox" style="width: 70%;">
        <h3 style="font-family: Georgia,'Times New Roman',Times,serif;"><a name=faq></a><?php _e('Plugin-FAQ', 'gb-jump-page') ?> [v<?php echo gxtb_jump_page_version; ?>]</h3>
			...
			<div class="inside">
					...
					<li><strong><?php _e('Design', 'gb-jump-page') ?>:</strong>
						<ul type="circle">
							<li><?php _e('You can design your jump-page on your own by adding the following css-class in your css-file', 'gb-jump-page') ?>: css-class="gbx_jump_page"</li>
						</ul>
					<br>
...
<?php // PayPal-Box 
	...
	// definiton of this project
	$art = "Plugin";
?>
<div class="stuffbox" style="width:70%">
    <h3 style="font-family:Georgia,'Times New Roman',Times,serif;"><a name=support></a><?php _e('Support', 'gb_iphone_webapp') ?>: <?php echo gxtb_jump_page_name; ?> [<?php echo $art; ?>]</h3>
        <div class="inside">
                    <p>'<?php echo gxtb_jump_page_name; ?>' 
					<?php _e('was created by', 'gb_iphone_webapp') ?> <a href="http://wordpress.org/extend/plugins/profile/gangxtaboii" target="_blank">Stefan Natter</a>. 
           			<?php _e('The development of this project took a lot of time and effort, so please don&rsquo;t forget to donate if you found this project useful.', 'gb_iphone_webapp') ?></p>
                    
                    <p><?php _e('There are also other ways of supporting this project to ensure it is maintained and well supported in the future!', 'gb_iphone_webapp') ?>
                    <?php _e('Rating the project on wordpress.org (if you like it), linking/spreading the word, and submitting code contributions will all help.', 'gb_iphone_webapp') ?> </p>
...
<div class="stuffbox" style="width:70%">
    <h3 style="font-family:Georgia,'Times New Roman',Times,serif;"><a name=news></a>GB-News</h3>
		...
		<ul type="circle">
			<li>	
<?php
$news = file_get_contents("http://www.gangxtaboii.com/downloads/wp/news.php?p=wpp&lang=". __('en', 'gb_iphone_webapp') . "&pfad=" . get_option('siteurl') . "&plugin=". gxtb_jump_page_name ."&version=". gxtb_jump_page_version);
echo $news;
?>		
		</li>
		</ul>
